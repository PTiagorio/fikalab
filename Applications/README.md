...
* **[IntelliJ IDEA](https://www.jetbrains.com/idea/download/)**
						...
						Directory Structure
1. Android-Device/	# Directory that contais the android studio project of the android app and the compiled .apk
  * EthAndroid/
  * GoPiGoRemoteController.apk
2. RaspberrypiAp/		# Directory that contains the maven project for the raspberry app as well as the compile .jar file for the app,
